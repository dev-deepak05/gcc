        ...
        <div className="container piechart-div">
          <div className="col-md-12">
            <div className="chart-title text-center">
              ...
              <h2 class="title">
                Sponser Reward <span class="word">Distribution</span>
              </h2>
            </div>
          </div>
        </div>
        <div className="container piechart-status">
          <div className="row">
            ...
            <div className="col-md-12 col-lg-4 chat-right-status">
              <div className="advisory">
                <h6 className="float-right">Level 15 Income :15%</h6>
                <div className="progress">
                  <div
                    class="progress-bar"
                    role="progressbar"
